// Auto-generated fix: Route all /api/* through Pages Functions using the existing worker logic.
// IMPORTANT: Cloudflare Pages D1 IMPORTANT: Cloudflare Pages D1 binding Name is set to DB in your project.
// The original worker expects env.DB. This wrapper maps env.DB_JOOLAB -> env.DB.
...
export async function onRequest(context) {
  ...
  const mappedEnv = { ...env, DB: env.DB || env.DB_JOOLAB };
  ...
  return await Worker.fetch(req, mappedEnv, ctx);
}
